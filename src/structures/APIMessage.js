...
class APIMessage {
  ...
  resolveData() {
	...
	if(this.options.embed) {
			if(!this.options.embeds) this.options.embeds = []
			this.options.embeds.push(this.options.embed)
			this.options.embed = null
	}
    ...
    this.data = {
      ...
      tts,
      nonce,
      embeds: this.options.embeds?.map(embed => new MessageEmbed(embed)),
      username,
      components: this.options.components === null ? null : this.options.components, // I did this, proud I am. Aydan
